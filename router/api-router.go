...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/codex/pool/sync", controller.SyncCodexChannelPool)
			channelRoute.POST("/:id/codex/pool/replenish", controller.ReplenishCodexChannelPool)
		...
		dataRoute.GET("/rankings", middleware.AdminAuth(), controller.GetQuotaUserRankings)
